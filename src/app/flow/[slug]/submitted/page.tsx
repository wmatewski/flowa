...
export default async function FlowSubmittedPage({
  ...
  const restartHref = age ? `/flow/${slug}?age=${age}&os=${selectedOperatingSystem}` : `/flow/${slug}`;
      ...
      <div className="wf-step-container">
        ...
        <section className="wf-step-card wf-step-success-card">
          ...
          <div className="wf-step-actions">
            <Link className="wf-btn wf-btn-secondary" href={restartHref}>
              Wróć do ankiety
            </Link>
            <Link className="wf-btn wf-btn-primary" href="/guides">
              Zobacz poradniki
            </Link>
          </div>
        </section>
