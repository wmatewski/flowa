...
const getFlashMessage = (params: Record<string, string | string[] | undefined>): FlashMessage | null => {
  ...
  if (params.error === "delete-confirmation") {
    return { type: "error", message: "Usuniecie sesji wymaga potwierdzenia." };
  }
                  ...
                  <td>
                    <div className="wf-sessions-actions">
                      ...
                      <form action={deleteSessionAction}>
                        ...
                        <DeleteSessionButton sessionId={session.session_id} sessionName={session.name} />
                      </form>
                    </div>
                  </td>
                </tr>
