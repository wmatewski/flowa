          ...
          >
            <div className="wf-page-header" style={{ marginBottom: 16 }}>
              <div>
                ...
                <p className="wf-table-muted">Pełny zapis danych odpowiedzi, urządzenia i sesji.</p>
              </div>
              <div className="wf-card-actions">
            ...
            <div className="wf-detail-stack">
              ...
              <div className="wf-detail-group">
                ...
                <div className="wf-detail-list">
                  ...
                  <div className="wf-member-row">
                    <span>Viewport</span>
                    <strong>{formatDetailValue(selectedParticipant.clientMetadata?.viewportDetails)}</strong>
                  </div>
                  <div className="wf-member-row">
                  ...
                  <div className="wf-member-row">
                    <span>Referrer</span>
                    <strong className="wf-detail-break">{formatDetailValue(selectedParticipant.clientMetadata?.referrer)}</strong>
                  </div>
                  <div className="wf-member-row">
              ...
              <div className="wf-detail-group">
                ...
                <div className="wf-detail-list">
                  ...
                  <div className="wf-member-row">
                    <span>Sieć (typ)</span>
                    <strong>{formatDetailValue(selectedParticipant.clientMetadata?.networkType)}</strong>
                  </div>
                  <div className="wf-member-row">
                    <span>Sieć (RTT)</span>
                    <strong>{formatNumberDetailValue(selectedParticipant.clientMetadata?.networkRttMs, " ms")}</strong>
                  </div>
                  <div className="wf-member-row">
                  ...
                  <div className="wf-member-row">
                    ...
                    <strong>{formatBooleanValue(selectedParticipant.clientMetadata?.networkSaveData, "Włączony", "Wyłączony")}</strong>
                  </div>
                  <div className="wf-member-row">
