    ...
    <div className="wf-page">
      ...
      <section className="wf-metric-grid" style={{ marginBottom: 24 }}>
        ...
        <article className="wf-metric-card">
          ...
          <div className="wf-table-muted">
            {formatPercentage(dashboard.metrics.sessionTrend)} ostatnie 30 dni
          </div>
        </article>
      </section>
